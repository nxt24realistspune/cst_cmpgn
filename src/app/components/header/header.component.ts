...
export class HeaderComponent {
  ...
  getReasoningButtonClass(): string {
    const baseClass = 'px-4 py-2 border rounded-lg transition-colors flex items-center gap-2';
    return this.showReasoningWindow 
      ? `${baseClass} bg-purple-100 border-purple-300 text-purple-700`
